...
class Settings(BaseSettings):
    service_role: str = "quota-service"
    service_name: str = "quota_service"
    service_title: str = "Quota service"
    service_description: str = "Owns quota policies, counters, priority throttling and usage events."
